...
func (*OAuthClient) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case oauthclient.FieldRedirectUris, oauthclient.FieldGrantTypes, oauthclient.FieldResources, oauthclient.FieldScopes:
			values[i] = new([]byte)
		case oauthclient.FieldActive:
			values[i] = new(sql.NullBool)
		case oauthclient.FieldTeamID, oauthclient.FieldClientID, oauthclient.FieldName, oauthclient.FieldClientType, oauthclient.FieldSecretHash:
...
func (_m *OAuthClient) Unwrap() *OAuthClient {
	...
	if !ok {
		panic("platform: OAuthClient is not a transactional entity")
	}
