	...
	return func(s *sql.Selector) {
		for _, f := range fields {
			if err := checkColumn(s.TableName(), f); err != nil {
				s.AddError(&ValidationError{Name: f, err: fmt.Errorf("platform: %w", err)})
			}
...
//	Aggregate(platform.As(platform.Sum(field1), "sum_field1"), (platform.As(platform.Sum(field2), "sum_field2")).
//	Scan(ctx, &v)
...
func Max(field string) AggregateFunc {
	return func(s *sql.Selector) string {
		if err := checkColumn(s.TableName(), field); err != nil {
			s.AddError(&ValidationError{Name: field, err: fmt.Errorf("platform: %w", err)})
			return ""
		}
...
func (e *NotFoundError) Error() string {
	return "platform: " + e.label + " not found"
}
...
func (e *NotSingularError) Error() string {
	return "platform: " + e.label + " not singular"
}
...
func (e *NotLoadedError) Error() string {
	return "platform: " + e.edge + " edge was not loaded"
}
...
func (e ConstraintError) Error() string {
	return "platform: constraint failed: " + e.msg
}
...
func (s *selector) Strings(ctx context.Context) ([]string, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("platform: Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) String(ctx context.Context) (_ string, err error) {
	...
	default:
		err = fmt.Errorf("platform: Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (s *selector) Ints(ctx context.Context) ([]int, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("platform: Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{s.label}
	default:
		err = fmt.Errorf("platform: Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (s *selector) Float64s(ctx context.Context) ([]float64, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("platform: Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{s.label}
	default:
		err = fmt.Errorf("platform: Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (s *selector) Bools(ctx context.Context) ([]bool, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("platform: Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{s.label}
	default:
		err = fmt.Errorf("platform: Bools returned %d results when one was expected", len(v))
	}
	return
}
