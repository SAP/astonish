...
const (
	// Label holds the string label denoting the a2aagent type in the database.
	Label = "a2a_agent"
	...
	// Table holds the table name of the a2aagent in the database.
	Table = "a2a_agents"
)

// Columns holds all SQL columns for a2aagent fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldURL,
...
// OrderOption defines the ordering options for the A2aAgent queries.
