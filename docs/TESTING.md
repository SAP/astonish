...
- Code and platform modes both describe MCP tools as deferred behind `search_tools`, `describe_tools`, and `execute_tool` (`TestCodeSystemPromptContracts_MCPUsesFixedBridge`)
