...
function ClientModal({ client, contexts, onCancel, onError, onSaved }: { client: OAuthClient | null; contexts: OAuthContext[]; onCancel: () => void; onError: (message: string) => void; onSaved: (message: string, secret: string) => void }) {
