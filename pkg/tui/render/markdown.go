...
func DefaultStyles() Styles {
	...
	return Styles{
		Background:    lipgloss.NewStyle().Background(lipgloss.Color("#111416")),
		Text:          lipgloss.NewStyle().Foreground(text).Background(lipgloss.Color("#111416")),
		Muted:         lipgloss.NewStyle().Foreground(muted).Background(lipgloss.Color("#111416")),
		Brand:         lipgloss.NewStyle().Foreground(brand).Background(lipgloss.Color("#111416")).Bold(true),
		Success:       lipgloss.NewStyle().Foreground(green).Background(lipgloss.Color("#111416")),
		Danger:        lipgloss.NewStyle().Foreground(red).Background(lipgloss.Color("#111416")),
		Number:        lipgloss.NewStyle().Foreground(orange).Background(lipgloss.Color("#111416")),
