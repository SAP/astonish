...
func (_c *DeckCreate) check() error {
	if _, ok := _c.mutation.Slug(); !ok {
		return &ValidationError{Name: "slug", err: errors.New(`team: missing required field "Deck.slug"`)}
	}
	...
	if _, ok := _c.mutation.Title(); !ok {
		return &ValidationError{Name: "title", err: errors.New(`team: missing required field "Deck.title"`)}
	}
	...
	if _, ok := _c.mutation.Description(); !ok {
		return &ValidationError{Name: "description", err: errors.New(`team: missing required field "Deck.description"`)}
	}
	if _, ok := _c.mutation.SchemaVersion(); !ok {
		return &ValidationError{Name: "schema_version", err: errors.New(`team: missing required field "Deck.schema_version"`)}
	}
	if _, ok := _c.mutation.ThumbnailReady(); !ok {
		return &ValidationError{Name: "thumbnail_ready", err: errors.New(`team: missing required field "Deck.thumbnail_ready"`)}
	}
	if _, ok := _c.mutation.SessionID(); !ok {
		return &ValidationError{Name: "session_id", err: errors.New(`team: missing required field "Deck.session_id"`)}
	}
	if _, ok := _c.mutation.Version(); !ok {
		return &ValidationError{Name: "version", err: errors.New(`team: missing required field "Deck.version"`)}
	}
	if _, ok := _c.mutation.SourceSlug(); !ok {
		return &ValidationError{Name: "source_slug", err: errors.New(`team: missing required field "Deck.source_slug"`)}
	}
	switch _c.driver.Dialect() {
	case dialect.MySQL, dialect.SQLite:
		if _, ok := _c.mutation.CreatedAt(); !ok {
			return &ValidationError{Name: "created_at", err: errors.New(`team: missing required field "Deck.created_at"`)}
		}
	}
	switch _c.driver.Dialect() {
	case dialect.MySQL, dialect.SQLite:
		if _, ok := _c.mutation.UpdatedAt(); !ok {
			return &ValidationError{Name: "updated_at", err: errors.New(`team: missing required field "Deck.updated_at"`)}
		}
	}
	return nil
}
