...
const (
	// Label holds the string label denoting the orgslidetemplate type in the database.
	Label = "org_slide_template"
	...
	// Table holds the table name of the orgslidetemplate in the database.
	Table = "org_slide_templates"
)

// Columns holds all SQL columns for orgslidetemplate fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldLabel,
...
// OrderOption defines the ordering options for the OrgSlideTemplate queries.
